...
<div class="container mt-lg-5">
    <form class="row" name="searchBookForm" method="POST"
        ...
        <input type="hidden" name="pagePath" value="jsp/searchBookByName.jsp"/>
        <div class="col-12">
            <label for="bookName" class="form-label">Название книги</label>
            <input type="text" class="form-control" id="bookName" placeholder="часть или полное название книги"
                   name="bookName">
        </div>
