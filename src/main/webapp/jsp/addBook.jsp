...
<div class="container mt-lg-5">
    <form class="row" name="addBookForm" method="POST"
          action="${pageContext.request.contextPath}/controller?command=addbook">
...
<div class="modal fade" id="addBookModalMenu" tabindex="-1" aria-labelledby="addBookModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addBookModalLabel">Добавление книги</h5>
...
<script src=${pageContext.request.contextPath}/js/add-new-book.js></script>
</html>
