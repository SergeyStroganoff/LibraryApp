...
<div class="container mt-lg-5">
    <form class="row" name="searchBookForm" method="POST"
        ...
        <input type="hidden" name="pagePath" value="jsp/searchBookInRange.jsp"/>
        <div class="col-md-4">
            <label for="inputPublishingYear" class="form-label">Начало периода - Год</label>
            <input type="text" class="form-control" id="inputPublishingYear" name="publishingYear">
        </div>
        <div class="col-md-4">
            <label for="inputPublishingYearSecond" class="form-label">Конец периода - Год</label>
            <input type="text" class="form-control" id="inputPublishingYearSecond" name="publishingYearSecond">
        </div>
