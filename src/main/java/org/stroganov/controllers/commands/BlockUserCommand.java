...
public class BlockUserCommand implements ActionCommand {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) {
        String page = ConfigurationManager.getProperties("path.page.blockUser");
        String userLogin = request.getParameter("inputUserLogin");
        request.setAttribute("status", "executed");
        request.setAttribute("messageTitle", MessageManager.getProperty("message.blockUser.title"));
        ...
        String resultMessage = changeUserStatusLogic.changeUserStatus(userLogin, "block");
